        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateStaticId = table.Column<int>(nullable: true),
                    DateTo = table.Column<DateTime>(nullable: true),
                    FilterClientIds = table.Column<string>(nullable: true),
                    FilterMemberIds = table.Column<string>(nullable: true),
                    FilterProjectIds = table.Column<string>(nullable: true),
                    FilterShowColumnIds = table.Column<string>(nullable: true),
                    GroupById = table.Column<int>(nullable: true),
                    IsCurrentQuery = table.Column<bool>(nullable: false),
                    LastEditorUserId = table.Column<string>(nullable: true),
                    LastUpdateDate = table.Column<DateTime>(nullable: false),
                    MemberId = table.Column<int>(nullable: false),
